...
// 초기화 함수: 주어진 노드를 초기화
// 이 함수는 주어진 노드를 초기화하여 자기 자신을 루트로 가지도록 함
// 시간복잡도: O(1)
...
int main() {
    ...
    // find 연산 수행 및 결과 출력
    std::cout << "find(1000000000): " << find(1000000000) << std::endl;
    std::cout << "find(1000000001): " << find(1000000001) << std::endl;
    std::cout << "find(2000000000): " << find(2000000000) << std::endl;
    std::cout << "find(2000000001): " << find(2000000001) << std::endl;
